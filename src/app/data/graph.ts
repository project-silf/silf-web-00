...
export type NodeDossier = {
  ...
  telemetry: {
    runs: TelemetryPoint[];
    latencyMs: TelemetryPoint[];
    quality: TelemetryPoint[];
  };
  logs: LogLine[];
  kudos: Kudo[];
};
...
export const dossiers: Record<string, NodeDossier> = {
    ...
    evolution: [
      {
        ...
        date: "May 2026",
        summary:
          "Tightened citation routing; added MiFID II §17 exception handling.",
        diff: {
    ...
    logs: [
      {
        ...
        at: "09:42",
        level: "success",
        text: "Run #318 completed in 712 ms",
      },
      {
        id: "l2",
        at: "09:38",
        level: "info",
        text: "Bound to Orion Customer Soul",
      },
      {
        id: "l3",
        at: "09:30",
        level: "warn",
        text: "Source Verifier flagged 1 stale citation",
      },
      {
        id: "l4",
        at: "09:12",
        level: "success",
        text: "Policy overlay applied (Governance Guard)",
      },
    ],
    kudos: [
      {
        ...
        to: "Compliance Report skill",
        reason: "Caught a MiFID §17 edge case",
        points: 25,
        at: "yesterday",
      },
      {
        id: "k2",
        from: "Mentor Companion",
        to: "Compliance Report skill",
        reason: "Reused for 3 customers this week",
        points: 15,
        at: "2d",
      },
    ],
  ...
  "sk-esg": {
    description:
      "Drafts an ESG narrative grounded in the customer corpus and regulatory framework.",
    evolution: [
      {
        version: "v2.2",
        date: "May 2026",
        summary: "Evolved: scope-3 emissions handling.",
        diff: {
          added: ["Scope-3 estimator"],
          removed: [],
          changed: ["Section weighting"],
        },
      },
      {
        version: "v2.1",
        date: "Apr 2026",
        summary: "Tone alignment per Customer Soul.",
        diff: { added: [], removed: [], changed: ["Tone overlay"] },
      },
    ],
    telemetry: {
    ...
    logs: [
      { id: "e1", at: "08:54", level: "success", text: "Run #142 completed" },
      {
        ...
        at: "08:50",
        level: "info",
        text: "Trained-on edge refreshed: ESG Framework v2026.2",
      },
    ],
    kudos: [
      {
        id: "ek1",
        from: "Helia Energy Soul",
        to: "ESG Narrative skill",
        reason: "Best fit for scope-3 disclosure",
        points: 20,
        at: "1w",
      },
    ],
  ...
  "agt-verifier": {
    description:
      "Cross-checks every claim against cited sources. Refuses to ship a draft without a source map.",
    evolution: [
      {
        version: "v3.0",
        date: "May 2026",
        summary: "Added per-claim confidence intervals.",
        diff: {
          added: ["Confidence intervals"],
          removed: [],
          changed: ["Source map format"],
        },
      },
    ],
    telemetry: {
    ...
    logs: [
      {
        ...
        at: "09:43",
        level: "warn",
        text: "Stale citation rejected on Run #318",
      },
      {
        id: "v2",
        at: "09:20",
        level: "success",
        text: "Audited 142 claims, 0 unsourced",
      },
    ],
    kudos: [
      {
        ...
        to: "Source Verifier",
        reason: "Zero unsourced claims this week",
        points: 30,
        at: "today",
      },
    ],
  ...
  "cus-orion": {
    description:
      "Customer Soul for Orion Logistics. 18-year relationship, freight-heavy operations.",
    evolution: [
      {
        version: "soul.5",
        date: "May 2026",
        summary: "Absorbed 2026 contracts addendum.",
        diff: {
          added: ["2026 addendum"],
          removed: [],
          changed: ["Service-level vocabulary"],
        },
      },
    ],
    telemetry: {
    ...
    logs: [
      {
        ...
        at: "09:38",
        level: "info",
        text: "Bound to Compliance Report skill",
      },
      {
        id: "o2",
        at: "08:00",
        level: "success",
        text: "Corpus sync: +14 new contract pages",
      },
    ],
    kudos: [
      {
        ...
        from: "Compliance Analyst",
        to: "Orion Soul",
        reason: "Pre-empted a 3-year-old exception",
        points: 10,
        at: "today",
      },
    ],
  ...
  "org-northwind": {
    description:
      "Northwind Holdings — the Organization Soul. Operational DNA: policies, tone, processes, compliance posture.",
    evolution: [
      {
        version: "soul.12",
        date: "May 2026",
        summary: "Adopted 2026 ESG policy.",
        diff: {
          added: ["ESG 2026 policy"],
          removed: [],
          changed: ["Tone guide"],
        },
      },
      {
        version: "soul.11",
        date: "Apr 2026",
        summary: "Org-wide MiFID II refresh.",
        diff: { added: [], removed: [], changed: ["Compliance scaffolding"] },
      },
    ],
    telemetry: {
    ...
    logs: [
      {
        ...
        at: "09:40",
        level: "success",
        text: "Session opened for org",
      },
      {
        id: "n2",
        at: "09:00",
        level: "info",
        text: "Daily graph refresh complete (+412 nodes)",
      },
    ],
    kudos: [
      {
        id: "nk1",
        from: "Mentor Companion",
        to: "Northwind Org Soul",
        reason: "Onboarded 4 new employees this week",
        points: 40,
        at: "today",
      },
    ],
...
export function dossierFor(id: string): NodeDossier {
  return (
    dossiers[id] ?? {
      description:
        "Sample SILF entity. Connect more sources to enrich its dossier.",
      evolution: [
        {
          version: "v0.1",
          date: "Today",
          summary: "Seeded from sample data.",
          diff: { added: ["Initial scaffold"], removed: [], changed: [] },
        },
      ],
      telemetry: {
